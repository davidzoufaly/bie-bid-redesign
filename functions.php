...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('custom-large', 700, '', true); // Large Thumbnail
    add_image_size('custom-medium', 210, '', true); // Medium Thumbnail
    add_image_size('custom-small', 200, '', true); // Small Thumbnail
    add_image_size('custom-size', 700, 200, true); // Custom Thumbnail Size call using 
...
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('mw_footer_scripts', get_template_directory_uri() . '/js/scripts.footer.min.js', '', '1.0.0', true); // Custom scripts
        wp_enqueue_script('mw_footer_scripts'); // Enqueue it!
    }
}
...
function html5blank_conditional_scripts()
{
    ...
    if (is_page_template('pages/results.php')) {
        wp_register_script('bie_results_scripts', get_template_directory_uri() . '/js/scripts.results.min.js', '' , '1.0.0', true); // Conditional script(s)
        wp_enqueue_script('bie_results_scripts'); // Enqueue it!
    }

    if (is_page_template('pages/statistics.php')) {
        wp_register_script('bie_graph_scripts', 'https://cdn.jsdelivr.net/npm/chart.js@2.8.0', '' , '1.0.0'); // Conditional script(s)
