        ...
        <form method="POST" action="./invoice.php" class="invoice-form">
            <fieldset class="invoice-form__fieldset">
                ...
                <div class="invoice-form__input-wrapper registrace-formular__row">
                    ...
                    <input type="text" id="postal-code" name="school_code" />
                </div>
                <div class="invoice-form__input-wrapper registrace-formular__row">
                    <label for="country"><?php _e('Country', 'BIE') ?></label>
            ...
            <fieldset>
                ...
                <select class="invoice-form__select" id="currency-select" name="payment_currency">
                    <option>---</option>
                    <option value="CZK">CZK</option>
                    <option value="EUR">EUR</option>
                </select>
                <p class="invoice-form__amount" id="amount-hook">
                    <p>
            </fieldset>
            <button type="submit"><?php _e('Generate Invoice', 'bie') ?></button>
        </form>
    </div>
        <script>
        document.querySelector('#currency-select').addEventListener('change', (event) => {
            document.querySelector('#amount-hook').textContent =
                `Total value: ${event.target.value === "CZK" ? <?php _e('900CZK', 'bie') ?> : <?php _e('35EUR', 'bie') ?>}`
        });
        </script>
        </div>
    </section>
