            ...
            <form id="registrace" class="registrace-formular" action="" method="post">
                <fieldset>
                    ...
                    <div class="registrace-formular__row">
                        ...
                        <select class="select-style" name="country" form="registrace" required>
                ...
                <fieldset>
                    ...
                    <div class="registrace-formular__row">
                        ...
                        <select class="select-style" name="students" form="registrace" required>
                ...
                <fieldset>
                    ...
                    <div class="registrace-formular__row">
                        ...
                        <select class="select-style" name="regionCZ" form="registrace">
                    ...
                    <div class="registrace-formular__row">
                        ...
                        <select class="select-style" name="regionSK" form="registrace">
                    ...
                    <div class="registrace-formular__row registrace-formular__row--checkboxes">
                        <h4>What type of school you are?</h4>
                        <p>You can choose one or more options at once</p>

                        <div class="checkboxes-wrapper">
                            <div>
                                <input class="inp-cbx" id="cbx1" type="checkbox" value="gymnasium" style="display: none;"/>
                            ...
                            <div>
                                <input class="inp-cbx" id="cbx2" type="checkbox" value="sos" style="display: none;"/>
                            ...
                            <div>
                                <input class="inp-cbx" id="cbx3" type="checkbox" value="sou" style="display: none;"/>
                            ...
                            <div>
                                <input class="inp-cbx" id="cbx4" type="checkbox" value="ostatni" style="display: none;"/>
                ...
                <div class="btn-wrap-center" style="margin-top: 40px;">
